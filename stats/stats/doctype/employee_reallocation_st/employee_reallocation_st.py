...
class EmployeeReallocationST(Document):
	def validate(self):
		...
		self.validate_new_main_department()
	...
	def validate_new_main_department(self):
		if self.new_main_department:
			if self.new_main_department == self.main_department:
				frappe.throw(_("Main department and New main department must be different"))
